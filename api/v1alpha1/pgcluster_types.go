...
type PGClusterSpec struct {
	...
	// Metadata that will be inherited by all objects related to the PGCluster
	// +optional
...
const (
	...
	PhaseHealthy = "PGCluster in healthy state"
	...
	PhaseImageCatalogError = "PGCluster has incomplete or invalid image catalog"

	// PhaseUnrecoverable for an unrecoverable cluster
	PhaseUnrecoverable = "PGCluster is in an unrecoverable state, needs manual intervention"

	// PhaseArchitectureBinaryMissing is the error phase describing a missing architecture
	PhaseArchitectureBinaryMissing = "PGCluster cannot execute instance online upgrade due to missing architecture binary"
...
func (status *PGClusterStatus) GetAvailableArchitecture(archName string) *AvailableArchitecture {
...
// These are valid conditions of a PGCluster, some of the conditions could be owned by
...
// EmbeddedObjectMetadata contains metadata to be inherited by all resources related to a PGCluster
...
type PostgresConfiguration struct {
	...
	// on this CloudNativePG PGCluster.
...
type ExternalCluster struct {
	...
	// PostgreSQL server from the current PostgreSQL `PGCluster`. This ensures
...
type ManagedConfiguration struct {
	// Database roles managed by the `PGCluster`
	// +optional
...
// +kubebuilder:printcolumn:name="Status",type="string",JSONPath=".status.phase",description="PGCluster current status"
// +kubebuilder:printcolumn:name="Primary",type="string",JSONPath=".status.currentPrimary",description="Primary pod"

// PGCluster is the Schema for the PostgreSQL API
...
func (cluster *PGCluster) GetEnableLDAPAuth() bool {
...
func (cluster *PGCluster) GetLDAPSecretName() string {
	if cluster.Spec.PostgresConfiguration.LDAP != nil &&
		cluster.Spec.PostgresConfiguration.LDAP.BindSearchAuth != nil &&
...
func (cluster *PGCluster) ContainsManagedRolesConfiguration() bool {
...
func (cluster *PGCluster) UsesSecretInManagedRoles(secretName string) bool {
...
func (cluster *PGCluster) GetApplicationSecretName() string {
...
func (cluster *PGCluster) GetApplicationDatabaseName() string {
	bootstrap := cluster.Spec.Bootstrap
	if bootstrap == nil {
		return ""
	}
...
func (cluster *PGCluster) GetApplicationDatabaseOwner() string {
	bootstrap := cluster.Spec.Bootstrap
	if bootstrap == nil {
		return ""
	}
...
// of the cluster
func (cluster *PGCluster) GetServerCASecretName() string {
...
func (cluster *PGCluster) GetServerTLSSecretName() string {
...
// of the cluster
func (cluster *PGCluster) GetClientCASecretName() string {
...
func (cluster *PGCluster) GetFixedInheritedAnnotations() map[string]string {
...
// inherited by all resources according the cluster spec
func (cluster *PGCluster) GetFixedInheritedLabels() map[string]string {
...
func (cluster *PGCluster) GetReplicationSecretName() string {
...
func (cluster *PGCluster) GetServiceAnyName() string {
...
func (cluster *PGCluster) GetServiceReadName() string {
...
func (cluster *PGCluster) GetServiceReadOnlyName() string {
...
func (cluster *PGCluster) GetServiceReadWriteName() string {
...
func (cluster *PGCluster) GetMaxStartDelay() int32 {
...
func (cluster *PGCluster) GetMaxStopDelay() int32 {
...
func (cluster *PGCluster) GetSmartShutdownTimeout() int32 {
...
func (cluster *PGCluster) GetMaxSwitchoverDelay() int32 {
...
func (cluster *PGCluster) GetPrimaryUpdateStrategy() PrimaryUpdateStrategy {
...
func (cluster *PGCluster) GetPrimaryUpdateMethod() PrimaryUpdateMethod {
...
func (cluster *PGCluster) GetEnablePDB() bool {
...
func (cluster *PGCluster) IsNodeMaintenanceWindowInProgress() bool {
...
func (cluster *PGCluster) GetPgCtlTimeoutForPromotion() int32 {
...
func (cluster *PGCluster) IsReusePVCEnabled() bool {
	reusePVC := true
...
// created
func (cluster *PGCluster) ShouldResizeInUseVolumes() bool {
...
func (cluster *PGCluster) ShouldCreateApplicationSecret() bool {
...
func (cluster *PGCluster) ShouldInitDBCreateApplicationSecret() bool {
...
func (cluster *PGCluster) ShouldPgBaseBackupCreateApplicationSecret() bool {
...
func (cluster *PGCluster) ShouldRecoveryCreateApplicationSecret() bool {
...
func (cluster *PGCluster) ShouldCreateApplicationDatabase() bool {
	return cluster.ShouldInitDBCreateApplicationDatabase() ||
...
func (cluster *PGCluster) ShouldInitDBRunPostInitApplicationSQLRefs() bool {
...
// job
func (cluster *PGCluster) ShouldInitDBCreateApplicationDatabase() bool {
	if cluster.Spec.Bootstrap == nil {
		return false
	}
...
// pg_basebackup job
func (cluster *PGCluster) ShouldPgBaseBackupCreateApplicationDatabase() bool {
...
// recovery job
func (cluster *PGCluster) ShouldRecoveryCreateApplicationDatabase() bool {
	// we skip creating the application database if cluster is a replica
	if cluster.IsReplica() {
		return false
	}
...
func (cluster *PGCluster) ShouldCreateProjectedVolume() bool {
...
// user
func (cluster PGCluster) GetPostgresGID() int64 {
...
func (cluster PGCluster) ExternalCluster(name string) (ExternalCluster, bool) {
...
func (cluster PGCluster) IsReplica() bool {
...
// GetSlotNameFromInstanceName returns the slot name, given the instance name.
// It returns an empty string if High Availability Replication Slots are disabled
func (cluster PGCluster) GetSlotNameFromInstanceName(instanceName string) string {
...
func (cluster PGCluster) GetBarmanEndpointCAForReplicaCluster() *SecretKeySelector {
	if !cluster.IsReplica() {
		return nil
	}
...
func (cluster *PGCluster) GetClusterAltDNSNames() []string {
...
// UsesConfigMap checks whether a given secret is used by a PGCluster
func (cluster *PGCluster) UsesConfigMap(config string) (ok bool) {
...
func (cluster *PGCluster) IsPodMonitorEnabled() bool {
...
func (cluster *PGCluster) GetEnableSuperuserAccess() bool {
...
func (cluster *PGCluster) IsInplaceRestartPhase() bool {
...
func (cluster *PGCluster) GetTablespaceConfiguration(name string) *TablespaceConfiguration {
...
func (cluster *PGCluster) UpdateBackupTimes(
